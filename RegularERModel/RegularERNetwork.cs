...
namespace RegularERModel
{
    ...
    public class RegularERNetwork : AbstractNetwork
    {
        public RegularERNetwork(String rName,
            ResearchType rType,
        ...
        {
            networkGenerator = new RegularERNetworkGenerator();
