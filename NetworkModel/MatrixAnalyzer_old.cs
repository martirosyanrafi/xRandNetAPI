...
namespace NetworkModel
{
    ...
    /// </summary>
    public class MatrixAnalyzer_old : AbstractNetworkAnalyzer
    {
        private MatrixContainer_old container;

        public MatrixAnalyzer_old(AbstractNetwork n) : base(n) { }

        public override INetworkContainer Container
        {
            get { return container; }
            set { container = (MatrixContainer_old)value; }
        }
