    ...
    public abstract class AbstractNetworkAnalyzer : INetworkAnalyzer
    {
        ...
        public Object CalculateOption(AnalyzeOption option)
        {
            switch (option)
            {
                ...
                case AnalyzeOption.Algorithm_3_By_Active_Nodes_List_Changing_Time:
                    return ActivationAlgorithm3();
                case AnalyzeOption.Algorithm_4_Final:
                    return ActivationAlgorithm4();
                default:
                    return null;
            }
        }
        ...
        protected virtual SortedDictionary<Double, Double> ActivationAlgorithm3()
        {
            throw new NotImplementedException();
        }

        protected virtual SortedDictionary<Double, Double> ActivationAlgorithm4()
        {
            throw new NotImplementedException();
        }
    }
